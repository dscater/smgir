        ...
        <div class="card">
            <div class="card-body">
                <div class="contenedor_cliente">
                    <div class="opciones">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-left" aria-labelledby="dropdownMenu1">
                                <li class="opcion_menu"><a href="{{ route('gaems.edit', $value->id) }}">Editar <i class="fa fa-edit"></i></a></li>
                                <li class="opcion_menu"><a href="{{ route('gaems.destroy', $value->id) }}" data-info="{{ $value->titulo }}" data-id="{{ $value->id }}" data-toggle="modal" data-target="#modal-eliminar" class="eliminar">Eliminar <i class="fa fa-trash"></i></a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="ci_cliente"><a href="">{{$value->ubicacion_url}}</a></div>
                    <div class="ci_cliente">
                    ...
                    <div class="ir_evaluacion" style="width:100%!important;">
                        <a href="{{route('gaem_reportes.index',$value->id)}}" class="ir-evaluacion btn btn-info" style="width:100%!important;"><i class="fa fa-plus"></i> AGREGAR REPORTE <span class="badge badge-danger right">{{count($value->reportes)}}</span></a>
                    </div>
                </div>
            </div>
        </div>
