<fieldset>
    <legend>REGISTRO DE ACTIVIDAD - GAEM</legend>
    <div class="row">
        <div class="col-md-4">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                {{ Form::select('distrito_id', isset($gaem) ? $array_distritos : [], null, ['class' => 'form-control', 'required', 'id' => 'distrito_id']) }}
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="file" name="ubicacion_img" class="form-control" {{ isset($gaem) ? '' : 'required' }}>
            </div>
        </div>
        <div class="col-md-4">
            <div class="form-group">
        ...
        <div class="col-md-4">
            <div class="form-group">
                ...
                {{ Form::date('fecha_inicio', isset($gaem) ? null : date('Y-m-d'), ['class' => 'form-control', 'required']) }}
            </div>
        </div>
    </div>
</fieldset>
