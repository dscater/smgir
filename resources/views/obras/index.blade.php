        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Administración de Obras</li>
                </ol>
            </div>
        </div>
    </div>
...
<section class="content">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <a href="{{ route('obras.create') }}" class="btn btn-info">
    ...
    <input type="hidden" id="urlListaRegistros" value="{{route('obras.index')}}">
</section>
