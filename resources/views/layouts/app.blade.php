...
<head>
    ...
    <!-- Date Picker -->
    <link rel="stylesheet" href="{{ asset('template/AdminLTE/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css') }}">
    <!-- Daterange picker -->
...
<body class="sidebar-mini layout-fixed layout-navbar-fixed layout-footer-fixed control-sidebar-slide-open text-sm">
    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar elevation-4 sidebar-blue bg-maroon">
            <!-- Brand Logo -->
            <a href="{{ route('home') }}" class="brand-link" style="color:black!important;">
                ...
                <span class="brand-text text-white"><b>SMGIR</b></span>
            </a>
                ...
                <nav class="mt-2">
                    ...
                    with font-awesome or any other icon font library -->
                        ...
                        @if (Auth::user()->tipo == 'TECNICO')
                            @include('includes.menu.menu_tecnido')
                        @endif
                    </ul>
                </nav>
                <!-- /.sidebar-menu -->
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; {{ date('Y') }} SMGIR</strong>
    ...
    <!-- datepicker -->
    <script src="{{ asset('template/AdminLTE/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js') }}"></script>
    <script src="{{ asset('template/AdminLTE/bower_components/bootstrap-datepicker/dist/locales/bootstrap-datepicker.es.min.js') }}"></script>
